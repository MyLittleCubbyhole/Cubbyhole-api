...
/**
 * Register some websocket events to process upload
 * @param  {object} socket
...
uploader.init = function(socket, sockets) {
	...
	/**
	 * Process data sended by the client to init an upload
	 *
	 *	ex: socket.emit('upload_init', {
	 *		id: "xxx", // random id generated by the client
	 *		owner: xx, // id of the owner
	 *		name: "xxx", // name of the file to upload
	 *		size: 1024, // size of the file to upload
	 *		type: "xxx", // mimeType of the file
	 *		path: "/xxx/", // path where to upload the file
	 *		token: "xxxxxx" // user token for authentication
	 *	});
	 *
	 * @param  {object} data data needed to init an upload
	 */
	...
	/**
	 * Get data sended by the client to save the file
	 *
	 * socket.emit('upload', {
	 *     data: data, // data part of the file
	 *     name: "xxx", // name of the file uploaded
	 *     id: xx // client id of the file
	 * });
	 *
	 * @param  {object} data data needed to process the upload
	 */
